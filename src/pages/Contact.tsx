        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <a
                  ...
                  className="bg-primary-50 hover:bg-primary-100 text-primary font-semibold py-3 px-4 rounded-xl text-xs sm:text-sm flex items-center justify-center gap-1.5"
                >
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white p-8 rounded-3xl border border-clinic-border space-y-4 shadow-sm">
              <h3 className="text-xl font-heading font-bold text-clinic-dark flex items-center gap-2">
                <MapPin className="w-5 h-5 text-secondary" /> Branch Addresses
              </h3>
              <div className="space-y-4 text-xs">
                {BRANCHES_DATA.map((b) => (
                  <div key={b.id} className="space-y-1">
                    ...
                    <p className="text-clinic-grey font-medium">Opposite: {b.landmark}</p>
                  </div>
                ))}
              </div>
            </div>
