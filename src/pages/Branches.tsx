          ...
          >
            ...
            <div className="lg:col-span-6 p-8 space-y-6 flex flex-col justify-between">
                ...
                <div className="space-y-3 text-sm text-clinic-dark">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-secondary font-medium mt-0.5">Landmark: {branch.landmark}</p>
              ...
              <div className="pt-4 border-t border-clinic-border flex flex-wrap gap-3">
                ...
                <a
                  href={`tel:${branch.phone.replace(/\s/g, '')}`}
                  className="bg-clinic-section hover:bg-clinic-border text-clinic-dark font-semibold py-3 px-4 rounded-xl border border-clinic-border text-xs sm:text-sm flex items-center gap-1.5"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="bg-secondary/10 hover:bg-secondary text-secondary hover:text-white font-semibold py-3 px-4 rounded-xl text-xs sm:text-sm flex items-center gap-1.5 transition-colors"
                >
