        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-clinic-section p-4 rounded-2xl border border-clinic-border">
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 rounded-xl border border-clinic-border bg-white text-xs text-clinic-dark focus:outline-none focus:border-secondary"
            />
          </div>
            ...
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] uppercase font-bold px-2.5 py-1 rounded-full bg-clinic-section text-primary border border-clinic-border">
                    {t.category}
                  </span>
                </div>
                ...
                <div className="space-y-2 pt-2 border-t border-clinic-border">
                  <span className="text-[11px] font-bold uppercase text-clinic-dark">Key Patient Benefits:</span>
